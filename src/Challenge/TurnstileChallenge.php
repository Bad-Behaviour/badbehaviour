...
class TurnstileChallenge implements ChallengeInterface
{
    ...
    {
        $response = $_POST['cf-turnstile-response'] ?? $_GET['cf-turnstile-response'] ?? '';
        ...
        $result = $this->http_post('https://challenges.cloudflare.com/turnstile/v0/siteverify', $data);
