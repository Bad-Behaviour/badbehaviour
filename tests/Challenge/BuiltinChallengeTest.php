...
final class BuiltinChallengeTest extends TestCase
{
	...
	{
		return new RequestPackage(ip: $ip, headers: [], headers_mixed: [
			'User-Agent' => 'Mozilla/5.0'
		], request_method: 'GET', request_uri: '/submit', server_protocol: 'HTTP/1.1', request_entity: [], user_agent: 'Mozilla/5.0');
	}
	...
	public function testVerifyReturnsFalseForUnissuedToken(): void
	{
		...
		$_POST = [
			'bb_challenge_token' => 'never_issued_token'
		];
	...
	public function testVerifyReadsTokenFromRequestEntityFirst(): void
	{
		...
		$package = $package->with_modified([
			'request_entity' => [
				'bb_challenge_token' => $token
			]
		]);
