...
class RetentionTestAdapter implements AdapterInterface, CacheInterface
{
	 ...
	 * Used to simulate adapters that genuinely
	...
	public function __construct(private string $logTable = 'bad_behaviour', private int|string|null $probeNewest = null, private int $probeTotal = 0, private ?string $probeError = null)
	{}
