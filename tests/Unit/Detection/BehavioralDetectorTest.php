...
class BehavioralDetectorTest extends TestCase
{
	...
	public function test_missing_accept_header_on_browser(): void
	{
		...
		$package = RequestPackage::create_for_test('Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/120.0.0.0 Safari/537.36', '192.0.2.1', 'GET', '/page', [
			'Host' => 'example.com',
			'Accept' => ''
		] // Explicitly empty Accept
		);
	...
	{
		$package = RequestPackage::create_for_test('Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/120.0.0.0 Safari/537.36', '192.0.2.1', 'POST', '/api/preview', [
			'Host' => 'example.com',
	...
	{
		$package = RequestPackage::create_for_test('Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/120.0.0.0 Safari/537.36', '192.0.2.1', 'POST', '/api/comment', [
			'Host' => 'example.com',
			'Content-Type' => 'application/json',
			'Accept' => 'application/json'
		], [
	...
	public function test_empty_referer_on_post(): void
	{
		...
		$package = RequestPackage::create_for_test('Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/120.0.0.0 Safari/537.36', '192.0.2.1', 'POST', '/comment', [
			'Host' => 'example.com',
	...
	public function test_rapid_requests_blocked(): void
	{
		...
		$package = RequestPackage::create_for_test('Mozilla/5.0 Chrome/120.0.0.0', '192.0.2.1', 'GET', '/page', [
			'Host' => 'example.com'
		], [], 'test-session');
	...
	public function test_form_timing_too_fast_blocked(): void
	{
		...
		$this->adapter->method('get_behavior_profile')->willReturnCallback(function ($session_id) {
			return [
