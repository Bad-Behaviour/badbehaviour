...
class MockFeed implements IpFeedInterface
{
    ...
    public function get_source_name(): string { return 'mock-feed'; }
    public function get_bot_ids(): array { return ['mockbot']; }
}
...
class CachedFeedDecoratorTest extends TestCase
{
    ...
    protected function setUp(): void
    {
        ...
        $this->innerFeed = new MockFeed(['mockbot' => ['1.2.3.4/32']]);
    ...
    public function test_returns_fresh_cache(): void
    {
        ...
        $this->assertEquals(['mockbot' => ['1.2.3.4/32']], $result);
    }
